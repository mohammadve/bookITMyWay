...
class StoreAddCategoryItemAdapterAdapter(val mContext: Context, val from: String, val offermodel: ArrayList<ItemPriceStoreModel>) : RecyclerView.Adapter<StoreAddCategoryItemAdapterAdapter.ResultItemViewHolder>() {

    var lisData: ArrayList<ItemPriceStoreModel> = offermodel

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ResultItemViewHolder {
        val view = LayoutInflater.from(mContext).inflate(R.layout.fragment_store_category_item_single_row, parent, false)
