...
import kotlinx.android.synthetic.main.fragment_offer_customer_item.view.*

class OfferAdapterCustomer(val mContext: Context, val offermodel: ArrayList<VenderOffersModel>, val clickListener: (VenderOffersModel) -> Unit) : RecyclerView.Adapter<OfferAdapterCustomer.ResultItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ResultItemViewHolder {
        val view = LayoutInflater.from(mContext).inflate(R.layout.fragment_offer_customer_item, parent, false)
    ...
    class ResultItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(mContext: Context, offModel: VenderOffersModel, clickListener: (VenderOffersModel) -> Unit) {
            ...
            itemView.txt_apply.setOnClickListener { clickListener(offModel) }
