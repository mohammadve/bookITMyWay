...
class MyAccountadapterVendor(val mContext: Context, val offermodel: ArrayList<OfferModel>) : RecyclerView.Adapter<MyAccountadapterVendor.ResultItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ResultItemViewHolder {
        val view = LayoutInflater.from(mContext).inflate(R.layout.fragment_myaccount_vendor_item, parent, false)
