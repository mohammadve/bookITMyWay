...
import kotlinx.android.synthetic.main.fragment_storedeliver_single_row.view.*
import java.util.*


class StoreDeliverLocationAdapter(val mContext: Context, val from: String, val offermodel: ArrayList<StoreItemLocationModel>) : RecyclerView.Adapter<StoreDeliverLocationAdapter.ResultItemViewHolder>() {

    var lisData: ArrayList<StoreItemLocationModel> = offermodel

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ResultItemViewHolder {
        val view = LayoutInflater.from(mContext).inflate(R.layout.fragment_storedeliver_single_row, parent, false)
