...
//import com.virtual.customervendor.model.StoreItemModel
...
//import kotlinx.android.synthetic.main.fragment_store_four_vendor.*
//
//class VendorStoreFourFragment : Fragment(), View.OnClickListener {
//
//    var datetime: String? = null
//    var TAG: String = VendorStoreFourFragment::class.java.simpleName
//    var storeAddItemsAdapter: StoreAddItemsAdapter? = null
//    var store_itemsnew: ArrayList<StoreItemModel> = ArrayList()
...
//
//    companion object {
//        fun newInstance(from: String): VendorStoreFourFragment {
//            val args = Bundle()
//            args.putString("name", from)
////            args.putInt("value", value)
//            val fragment = VendorStoreFourFragment()
...
//        var mView = inflater.inflate(R.layout.fragment_store_four_vendor, container, false)
//        return mView
//    }
//
...
//        try {
//            if (vendorstoreRequest?.store_itemsnew?.size != 0) {
