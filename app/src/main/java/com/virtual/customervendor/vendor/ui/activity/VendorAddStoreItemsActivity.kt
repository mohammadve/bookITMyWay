...
import kotlinx.android.synthetic.main.activity_add_storeitem_vendor.*
...
class VendorAddStoreItemsActivity : BaseActivity(), View.OnClickListener, ViewPagerItemClicked {
    override fun onPagerItemClicked(position: Int) {
    }

    var TAG: String = VendorAddStoreItemsActivity::class.java.simpleName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_storeitem_vendor)
