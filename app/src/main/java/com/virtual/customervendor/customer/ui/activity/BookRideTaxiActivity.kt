...
class BookRideTaxiActivity : BaseActivity(), View.OnClickListener, RegionDialogFragmentSingle.SingleRegionSelectionInterface, CountryDialogFragment.countrySelectionInterface {
    ...
    var TAG: String = BookRideTaxiActivity::class.java.simpleName
    var orderNo = String()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_book_ride_taxi)
