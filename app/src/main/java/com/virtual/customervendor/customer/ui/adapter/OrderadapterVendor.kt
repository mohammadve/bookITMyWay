...
import kotlinx.android.synthetic.main.fragment_orders_vendor_item.view.*

class OrderadapterVendor(val pagingListener: PagingListeners, val mContext: Context, val offermodel: ArrayList<CustomerOrderModel>, val clickListener: (CustomerOrderModel) -> Unit) : RecyclerView.Adapter<OrderadapterVendor.ResultItemViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ResultItemViewHolder {
        val view = LayoutInflater.from(mContext).inflate(R.layout.fragment_orders_vendor_item, parent, false)
    ...
    class ResultItemViewHolder(itemView: View, val clickListener: (CustomerOrderModel) -> Unit) : RecyclerView.ViewHolder(itemView) {
        fun bind(mContext: Context, offModel: CustomerOrderModel) {
            if (offModel.order_id != null) {
                ...
                itemView.businessname.text = offModel.customer_name
