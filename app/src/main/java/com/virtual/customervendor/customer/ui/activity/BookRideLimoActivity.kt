...
class BookRideLimoActivity : BaseActivity(), View.OnClickListener, RegionDialogFragmentSingle.SingleRegionSelectionInterface , CountryDialogFragment.countrySelectionInterface {
    ...
    var TAG: String = BookRideLimoActivity::class.java.simpleName
