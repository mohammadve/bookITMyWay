...
import com.virtual.customervendor.customer.ui.dialogFragment.ServiceSlectionDialogFragmentMulti
...
class BookAppointmentMassageActivity : BaseActivity(), View.OnClickListener, RegionDialogFragmentSingle.SingleRegionSelectionInterface, TimeDialogFragment.timeSelectionInterface , CountryDialogFragment.countrySelectionInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_book_appointment_massage)
    ...
    fun init() {
        ...
        setDisplayFragment(1, resources.getString(R.string.physio_fitnesstrainer), false)
    }
    ...
    fun handleBackPress() {
        when {
            ...
            fragmentManager!!.findFragmentById(R.id.flContentnew) is AppoinmentBodayCareBusinessProfileFragment -> {
                if (!isFromSearch) {
                    setTitleBar(resources.getString(R.string.physio_fitnesstrainer))
    ...
    fun showTimeSelectionDialog(date: String) {
        ...
        customerTimeSlotRequest.subcategory_id = AppConstants.SUBCAT_HEALTH_PHYSIO.toString()
    ...
    public fun showServiceSelectionDialogMulti(from: String) {
