...
class VendoradapterCustomer(val mContext: Context, val offermodel: ArrayList<OfferModel>) : RecyclerView.Adapter<VendoradapterCustomer.ResultItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ResultItemViewHolder {
        val view = LayoutInflater.from(mContext).inflate(R.layout.fragment_vendor_customer_item, parent, false)
