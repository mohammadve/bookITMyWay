...
import com.virtual.customervendor.customer.ui.adapter.PurschaseHistoryadapterCustomer
...
class PurchaseHistoryFragment : Fragment(), View.OnClickListener {
    ...
    lateinit var purschaseHistoryadapterCustomer: PurschaseHistoryadapterCustomer
...
//            R.id.btn_purchase->{startActivity(Intent(activity, PurchaseItemsActivity::class.java))}
    ...
    private fun createAdapterView() {
        ...
        purschaseHistoryadapterCustomer = PurschaseHistoryadapterCustomer(activity!!, list)
        val manager = LinearLayoutManager(activity, LinearLayoutManager.VERTICAL, false)
        rv_list.layoutManager = manager
        rv_list.adapter=(purschaseHistoryadapterCustomer)
    }
}