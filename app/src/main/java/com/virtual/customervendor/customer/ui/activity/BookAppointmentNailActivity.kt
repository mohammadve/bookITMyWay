...
class BookAppointmentNailActivity : BaseActivity(), View.OnClickListener, RegionDialogFragmentSingle.SingleRegionSelectionInterface, TimeDialogFragment.timeSelectionInterface, CountryDialogFragment.countrySelectionInterface, ServiceSlectionDialogFragmentMulti.MultiServiceSelectionInterfaceService {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_book_appointment_nail)
    ...
    fun init() {
        ...
        if (isFromSearch) {
            ...
            setDisplayFragment(1, resources.getString(R.string.spa), false)
    }
    ...
    fun handleBackPress() {
        when {
            ...
            fragmentManager!!.findFragmentById(R.id.flContentnew) is AppoinmentBodayCareBusinessProfileFragment -> {
                if (!isFromSearch) {
                    setTitleBar(resources.getString(R.string.spa))
    ...
    fun showTimeSelectionDialog(date: String) {
        ...
        customerTimeSlotRequest.subcategory_id = AppConstants.SUBCAT_HEALTH_NAIL.toString()
